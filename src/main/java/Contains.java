...
public class Contains {
     ...
     * You will need to use a for loop to check every value of the array to see if
     * it matches the target value.
     *
    ...
    public boolean arrayContains(int[] arr, int target) {
        ...
        for(int i = 0; i < arr.length; i++) {
            boolean doesContain = (target == arr[i]);
...
// check each value of array with target
// if target is found in array, return true
// if target not found in array, return false